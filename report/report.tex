...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{shorcode_with_correction.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{test1_bit_flip_correction.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{test2_phase_flip_correction.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{test3_y_error_correction.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{test4_multiple_errors.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{test5_random_error_statistics.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{test6_noise_model_comparison.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{test6_overall_noise_performance.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{test7_error_correction_performance.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{test7_correction_vs_no_correction.png}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        \includegraphics[width=\textwidth]{test7_x_error_targeted.png}
        \caption{X error (bit-flip)}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.49\textwidth}
        \includegraphics[width=\textwidth]{test7_z_error_targeted.png}
        \caption{Z error (phase-flip)}
    \end{subfigure}
    
    \begin{subfigure}[b]{0.49\textwidth}
        \includegraphics[width=\textwidth]{test7_y_error_targeted.png}
        \caption{Y error (combined bit and phase-flip)}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.49\textwidth}
        \includegraphics[width=\textwidth]{test7_depol_error_targeted.png}
